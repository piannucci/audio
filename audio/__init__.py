...
try:
    ...
    setup(
        ...
        ext_modules=[
             Extension("_coreaudio", ["_coreaudio.pyx"], extra_link_args=["-framework", "CoreAudio", "-framework", "CoreFoundation"])
             ],
...
from coreaudio import play, record, play_and_record, AudioInterface, devices
import stream
